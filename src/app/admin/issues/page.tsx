...
export const metadata: Metadata = noIndexMetadata(`Admin Issues | ${APP_NAME}`, 'Private admin issues placeholder page.');
    ...
    <AdminAppShell activeKey="clearance">
      <div className="rounded-2xl border border-background-secondary bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-500">
          The locked mockups consolidate issue review inside the Global Clearances workspace. Use that page to inspect unresolved issue reports alongside paid clearance checks and wallet operations.
        </p>
